...
//   console.log(randomIndex)
  ...
  return (
    ...
    <p className='bestSeller'>MOBILES-VIVO</p>
...
{ContextData.filter((item)=> item && item.id === 8).map((item,index)=>{
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 9).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 10).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 11).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 12).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
