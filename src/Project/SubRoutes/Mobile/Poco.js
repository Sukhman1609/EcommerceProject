...
//   console.log(randomIndex)
  ...
  return (
    ...
    <p className='bestSeller'>MOBILES-POCO</p>
    <hr className='bestSellerHr1'></hr>
<div className='cards1'>
<div className='box1'>
{ContextData.filter((item)=> item && item.id === 26).map((item,index)=>{
          console.log(item);
          return(   <div >
  ...
  {/* <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 27).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 28).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 29).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 30).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 31).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 270).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
