...
//   console.log(randomIndex)
  ...
  return (
    ...
    <p className='bestSeller'>MOBILES-REALME</p>
    <hr className='bestSellerHr1'></hr>
<div className='cards1'>
<div className='box1'>
{ContextData.filter((item)=> item && item.id === 20).map((item,index)=>{
          console.log(item);
          return(   <div >
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 21).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 22).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 23).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 24).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
  ...
  <div className=' box1'>
{ContextData.filter((item)=> item && item.id === 25).map((item,index)=>{
          console.log(item);
          return(   <div >
          <img src={item.bollywoodimg} alt={item.name} className='subImg' />
           <p className='name' >{item.name}</p> 
